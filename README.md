#
Purdue Gold IronHacks Otoño 2018 Tutorials

## Spanish vesion

Bienvenidos al Purdue Gold IronHacks - Otoño 2018! A continuación, encontrarán varios vídeo tutoriales relacionados con los conocimientos necesarios para resolver el reto de programación que tendrán que afrontar. Les pedimos a todos que revisen todo el material antes del inicio de la competencia. La competencia iniciará el **INCLUIRFECHA**.
## Sesión 1
...
### Plataforma de codificación (Social Coding Platform)

Es necesario que todo el código sea enviado a nuestro sistema por medio de la plataforma de codificación (Social Coding Platform)<br>

**[Iniciando en Github](session1/Github/Github-Tutorial.md)** -- Una pequeña introducción a Git y GitHub, desde cómo instalarlo hasta su uso básico (no es necesario para la competencia pero es muy útil si tienes curiosidad)

**[Entendiendo GIT](https://www.atlassian.com/git/tutorials/what-is-git)** -- Un muy buen tutorial de Git (no es necesario para la competencia pero es muy útil si tienes curiosidad)
...
<i><small>El concuso inicia **INCLUIRFECHA**.</small></i><br>
...
El reglamento de Ironhacks demarca como requerimiento OBLIGATORIO el uso de datos abiertos en la solución del problema, a continuación encontrarán una lista de los datasets disponibles para ser utilizados:
...
#### Diseño I:
En esta sesión se hablará sobre principios de diseño y usabilidad, a continuación pueden encontrar material de apoyo para esta etapa:
...
#### Material de apoyo:
**[Video sobre usabilidad 1](https://www.dropbox.com/s/skabjjtp1k5bcbp/Tutorial%201of3%20on%20Design%20Elements.mov?dl=0)**<br>
...
En esta sesión se atenderán dudas sobre visualización de información, además, el estudiante embajador brindará apoyo técnico para la solución del problema.
...
2. ¿Se puede trabajar en equipos?
* No, IronHacks es una competencia totalmente individual.

3. ¿Puedo utilizar plantillas o código tomado de Internet?
